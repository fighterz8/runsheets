        ...
        content: [
          {
            ...
            text: [
              ...
              'Use exactly these categories: Alcohol, Dry Goods/Wares, Bar Installations, Bar Essentials, Kitchen + Miscellaneous, SOC Cocktail Mixers, Garnishes, Modifiers/Perishables, Decor, POS & Tech Equipment, Named Sections.',
              'Alcohol must be subcategorized as exactly one of: Spirits, Wine, Beer, Champagne/Sparkling, Sake/Other. Infer from item name, for example Daou Cabernet is Wine and Don Julio is Spirits.',
              'SOC Cocktail Mixers is a named Snake Oil category. Classic Marg, Eye of the Tiger, and similar house cocktail mixes always go in SOC Cocktail Mixers, not Kitchen + Miscellaneous.',
